...
import { ChevronLeft, ChevronRight, Droplets, Shield, Cog, Wrench, Check } from "lucide-react";
...
export default function Graisse() {
  ...
  const features = [
    { icon: Droplets, title: "Lubrification", description: "Réduit friction et usure des roulements" },
    { icon: Shield, title: "Protection", description: "Excellente résistance à la corrosion" },
    { icon: Cog, title: "Charges Lourdes", description: "Adaptée aux charges et chocs" },
    { icon: Wrench, title: "Usage Polyvalent", description: "Automobile et industrie" }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#02173C] to-[#02173C]/90 text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://cdn.builder.io/api/v1/image/assets%2F367800b539f442f7b8aca37c33d3b377%2F04c864c21dde4aef9412459e8399e803?format=webp&width=1200" 
            alt="Graisse"
        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              <span className="block bg-gradient-to-r from-[#BE941B] to-white bg-clip-text text-transparent">Graisse</span>
            </h1>
            <div className="w-32 h-1 bg-gradient-to-r from-[#BE941B] via-white to-[#BE941B] mx-auto mb-8 rounded-full"></div>
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Graisses techniques multi‑usages pour roulements, châssis et applications industrielles.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Produits NLGI 2 pour conditions sévères et protection durable.
            </p>
          </div>
              ...
              <Link key={p.id} to={`/produits/graisse/${p.id}`} className="group cursor-pointer">
                <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 border border-gray-100">
                  <div className="bg-gradient-to-r from-[#BE941B] to-[#02173C] text-white text-center py-3 px-4">
                    <span className="font-bold text-sm uppercase tracking-widest">{p.code}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div className="text-white">
              <div className="inline-flex items-center bg-[#BE941B]/20 border border-[#BE941B]/30 rounded-full px-6 py-2 mb-8">
                <Droplets className="w-4 h-4 text-[#BE941B] mr-2" />
                <span className="text-[#BE941B] font-bold text-sm uppercase tracking-widest">Avantages Graisse</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">Protection <span className="text-[#BE941B]">longue durée</span></h2>
              <div className="w-24 h-1 bg-[#BE941B] mb-8 rounded-full"></div>
              <div className="space-y-4 mb-8">
                {[
                  "Excellente adhésivité et pouvoir lubrifiant",
                  "Résistance à l'eau et à l'oxydation",
                  "Convient aux roulements et châssis",
                  "Conditionnements 900g, 4kg, 16kg"
                ].map((b, i) => (
            ...
            <div className="relative">
              <div className="aspect-square relative overflow-hidden rounded-3xl">
                <img src="https://images.pexels.com/photos/162553/grease-lubrication-lubricant-greasy-162553.jpeg" alt="Graisse" className="w-full h-full object-cover" />
