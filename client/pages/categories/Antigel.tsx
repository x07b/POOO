...
export default function Antigel() {
  const products = [
    {
      id: "dinoil-antifreeze-g12-g13-vw",
  ...
  const features = [
    { icon: Snowflake, title: "Protection Froid", description: "Jusqu'à -70°C selon dilution" },
    { icon: Shield, title: "Anticorrosion", description: "Protection de l'aluminium et alliages" },
    { icon: Droplets, title: "Concentré / Prêt à l'emploi", description: "Selon référence produit" },
    { icon: Award, title: "Normes Constructeurs", description: "Conformité VW TL, SAE/ASTM" }
  ];
      ...
      <section className="relative bg-gradient-to-br from-[#02173C] to-[#02173C]/90 text-white py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <nav className="flex items-center space-x-2 text-sm mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight size={16} className="text-gray-400" />
            <span className="text-[#BE941B] font-medium">Antifreeze / Antigel</span>
          </nav>
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              <span className="block">Liquides</span>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Antigels concentrés et prêts à l'emploi pour systèmes modernes en aluminium.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Protection anti-gel/anti-ébullition pour tous types de véhicules
            </p>
          </div>
