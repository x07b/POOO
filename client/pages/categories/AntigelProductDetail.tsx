...
import { ChevronLeft, ChevronRight, Snowflake, Check, Package, FileText } from "lucide-react";

export default function AntigelProductDetail() {
  const { productId } = useParams();

  const products = {
    "dinoil-antifreeze-g12-g13": {
      ...
      category: "Antigel Concentré Rouge",
      description:
        "Antigel concentré de couleur rouge, sans nitrites, amines ni phosphates. Convient à tous les véhicules, assure une protection jusqu'à -70°C selon la dilution. Protège de la surchauffe et de la corrosion de toutes les parties métalliques, y compris l'aluminium et ses alliages.",
      specifications: [
      ...
      packages: ["1 kg", "20 kg", "230 kg"],
      features: [
        "Concentré rouge G12/G13",
        "Sans nitrites, amines, phosphates",
        "Protection jusqu'à -70°C (dilution)",
        "Protection anti‑corrosion aluminium",
    ...
    "dinoil-antifreeze-pure-g11-red": {
      ...
      code: "1912",
      image: "https://cdn.builder.io/api/v1/image/assets%2F367800b539f442f7b8aca37c33d3b377%2Fb0acc5ca816e40a98d8d57b2f07bf21f?format=webp&width=800",
      category: "G11 Rouge Concentré",
      description:
        "Liquide antigel rouge concentré, formulé avec additifs de haute performance. Protection contre surchauffe, rouille et corrosion. Diluable à l'eau selon le point de congélation souhaité.",
      specifications: ["SAE J1034", "CUNA NC 959‑16", "VW TL 774 D"],
      packages: ["1 kg", "20 kg", "230 kg"],
      features: [
        "Couleur rouge",
        "Protection -70°C selon dilution",
        "Anti‑corrosion et anti‑boue",
        "Convient à tous véhicules"
      ]
    },
    "dinoil-antifreeze-pure-g11-yellow": {
      ...
      code: "4654",
      image: "https://cdn.builder.io/api/v1/image/assets%2F367800b539f442f7b8aca37c33d3b377%2Fb0acc5ca816e40a98d8d57b2f07bf21f?format=webp&width=800",
      category: "G11 Jaune Concentré",
      description:
        "Antigel concentré de couleur jaune. Protège le moteur de la surchauffe, de la rouille et de la corrosion. Diluable à l'eau selon le point de congélation désiré.",
      specifications: [
        "SAE J‑1034",
        "ASTM D3306 / D4985",
        "MB 325.2",
      ...
      packages: ["1 kg", "4 kg", "20 kg", "230 kg"],
      features: [
        "Couleur jaune",
    ...
    "dinoil-antifreeze-pure-g11-blue": {
      ...
      code: "1905",
      image: "https://cdn.builder.io/api/v1/image/assets%2F367800b539f442f7b8aca37c33d3b377%2Fb0acc5ca816e40a98d8d57b2f07bf21f?format=webp&width=800",
      category: "G11 Bleu Concentré",
      description:
        "Antigel anti‑thermique adapté à tous les véhicules, protection jusqu'à -70°C selon dilution. Protège de la surchauffe, de la corrosion et de la boue rouillée.",
      specifications: ["CUNA NC 956 16/017", "VW TL 774 C"],
      packages: ["1 kg", "4 kg", "20 kg", "230 kg"],
      features: [
        "Couleur bleue",
        "Protection jusqu'à -70°C",
        "Anti‑corrosion / Anti‑boue",
        "Convient tous véhicules"
      ]
    },
    "dinoil-antifreeze-permanent-g11": {
      ...
      code: "1929 / 1939",
      image: "https://cdn.builder.io/api/v1/image/assets%2F367800b539f442f7b8aca37c33d3b377%2Fb0acc5ca816e40a98d8d57b2f07bf21f?format=webp&width=800",
      category: "G11 Permanent",
      description:
        "Antigel anti‑warm prêt à l'emploi à -40°C ou -20°C selon référence. Protège du gel, de la surchauffe, de la rouille et de la corrosion. Peut aussi être dilué pour ajuster le point de congélation.",
      specifications: ["CUNA NC 956 16/017", "VW TL 774 C", "SAE J‑1034"],
      packages: ["1 kg", "4 kg", "20 kg", "230 kg"],
      features: [
        "Prêt à l'emploi -40°C / -20°C",
        "Protection anti‑corrosion",
        "Adapté à tous moteurs",
        "Peut être dilué si nécessaire"
      ]
    }
  } as const;
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <Link to="/produits/antigel" className="inline-flex items-center bg-[#BE941B] text-white px-6 py-3 rounded-xl hover:bg-[#02173C] transition-colors">
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#02173C] to-[#02173C]/90 text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1514511547117-f9f9d6060b6e?w=1200&q=80" alt={product.name} className="w-full h-full object-cover opacity-20" />
      ...
      <section className="py-16 bg-gradient-to-r from-gray-50 to-white">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <Link to="/produits/antigel" className="group inline-flex items-center bg-white hover:bg-[#02173C] border-2 border-[#02173C] text-[#02173C] hover:text-white px-8 py-4 rounded-2xl transition-all duration-300 font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
